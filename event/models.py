...
class participants(models.Model):
    ...
    #By using unique_together, you can ensure that each person can participate in an event only once. It maintains data integrity and prevents the creation of duplicate participation entries.
    class Meta:
    ...
    #fama tofla telbes cargo, ta9ra premiere to93ed wine terrain wtetkayef

#Un tuple 7aja metetbadalch