...
# hedha au prinicpe ywari les listes des participants foset tabelau event
class ParticipationInline(admin.TabularInline):
    model = participants
    readonly_fields=('date_participation',)
    extra = 1 #twarik 9adeh min ligne par exemple extra 1 ligne 1
    can_delete=False
    classes =['collapse']# css w jaw
